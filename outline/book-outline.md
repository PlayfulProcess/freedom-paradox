...
Former Goldman Sachs equity research analyst. MSW student. Builder on open-source tools (Supabase, Vercel, Next.js). Student of Tillich, Yalom, Kelty, Ostrom. The rare person who can read a 10-K filing, engage with Habermas, and deploy a Postgres database. This book is written from the intersection.
