...
The effective altruism framework — rational optimization applied to global suffering — is a grammar in the sense this book uses the term. It is among the most productive governance infrastructures the Enlightenment has produced. It is also, like all Enlightenment products, a constraint without content — it eliminates bad options without generating the communal practices that make good options livable. Both are true. The framework needs grammars. The grammars need the framework's rigor.
