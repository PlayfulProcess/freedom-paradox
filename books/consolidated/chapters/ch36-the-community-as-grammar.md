...
**Open Dialogue** — developed in Finland for acute psychosis — produces eighty-one percent symptom-free outcomes by creating conditions where all voices in the system are heard, including the patient's. The principle: even in the most extreme dysregulation, the relational field can hold if the structure is right. <!-- Seikkula et al. — Open Dialogue, Western Lapland. 81% figure attributed in research-27. -->
