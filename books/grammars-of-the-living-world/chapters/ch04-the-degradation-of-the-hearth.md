...
And the effects are measurable. Infants of parents with habitual technoference show an attenuated negative emotional response during phone-absorption episodes — a pattern resembling the learned helplessness observed in infants of chronically depressed mothers. A single researcher found that maternal phone use was associated with a sixteen-percent decrease in infants' speech input. The smartphone does not just reduce parental attention. It makes parental attention intermittent and unpredictable — converting a regulated signal into noise. [VERIFY: Mikhelson 16% speech decrease — exact study]
