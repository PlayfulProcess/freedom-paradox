...
The research from the first chapter applies directly. Lucas Parra's lab demonstrated that heart rates synchronize across subjects attending to the same content — but Baranowski-Pinto's study of basketball fans found that in-person attendance produced significantly greater physiological synchrony than remote viewing, and higher synchrony predicted transformative experience *only* for those physically present. Co-viewing preserved some co-regulation. But the screen was thinner than the fire.
...
And the effects are measurable. Infants of parents with habitual technoference show an attenuated negative emotional response during phone-absorption episodes — a pattern resembling the learned helplessness observed in infants of chronically depressed mothers. A single researcher found that maternal phone use was associated with a sixteen-percent decrease in infants' speech input. The smartphone does not just reduce parental attention. It makes parental attention intermittent and unpredictable — converting a regulated signal into noise. <!-- Mikhelson et al. — 16% overall decrease confirmed; 26% for brief episodes. Year not in research files. -->
...
The fire was a grammar: communal, embodied, responsive, constraining. Television was a degraded grammar: shared attention without feedback, story without participation. The personal screen is not a grammar at all. It is a consumption device optimized for extraction — maximum engagement, zero co-regulation, no seventh-generation thinking.

Byung-Chul Han describes the result: "communication without community" — constant messaging that fails to create belonging. The smartphone, he writes, "serves to renew the mirror stage after infancy. It opens up a narcissistic space in which one encloses oneself. The Other does not speak via the smartphone." Without the genuine alterity of another consciousness — its resistance, its opacity, its capacity to surprise — communication "degenerates into an accelerated exchange of information."
