...
**Open Dialogue** — developed in Finland for acute psychosis — produces eighty-one percent symptom-free outcomes by creating conditions where all voices in the system are heard, including the patient's. The principle: even in the most extreme dysregulation, the relational field can hold if the structure is right. (Seikkula, Alakare & Aaltonen, "The Comprehensive Open-Dialogue Approach II: Long-term stability of acute psychosis outcomes in advanced community care," *Psychosis* 3(3): 192–204, 2011)
