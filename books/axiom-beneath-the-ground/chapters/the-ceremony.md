...
The cost of this work with AI — you want to know what it costs? It costs the slow work. Every time someone asks a chatbot for emotional support instead of calling a friend, that's a rep they didn't do. Every deferred judgment is a lost occasion for practicing virtue. The moral muscle atrophies from disuse. And the atrophy is invisible because the AI is so good at performing the function the muscle used to serve.
