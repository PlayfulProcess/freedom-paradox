...
Svātantrya is the innate freedom and total autonomy of Consciousness (Cit / Śiva / Paramaśiva). It is not a faculty possessed by individual jīvas. It is the single, unimpeded capacity of the whole field of Awareness to self-determine and self-manifest. The Five Powers — *cit*, *ānanda*, *icchā*, *jñāna*, *kriyā* — operate as expressions of this one freedom. Svātantrya is sometimes called the "sixth power," but not as a sixth alongside the five; rather as the containing context, the one nature of which the five are analytical aspects.

Key TI locations:
- **pp. 101–109** — "The Five Powers of God," where svātantrya is introduced as Consciousness's innate freedom and as the containing context of the Five Powers (the user's locator of ~p. 105 is consistent).
- **~p. 157** — discussion of the three *malas* (impurities), where svātantrya contracted as the Power of Will becomes *āṇava-mala* (the impurity of individuality, the state of feeling incomplete).
- **p. 236** — the Trika triad Parā/Parāparā/Aparā.
- **p. 385ff.** — the twelve Kālīs and the Wheel of Powers.

`[RESEARCH NEEDED: confirm the TI 2nd-ed. index entry for svātantrya / svātantrya-śakti against a physical copy; online previews do not expose the index.]`
...
The practical consequence: freedom is not something individual persons have more or less of; it is the one nature of the totality, expressing itself through apparent parts. The apparent agency of jīvas is that one freedom contracted, refracted, and self-occluded. Liberation is the recognition that the freedom one has been seeking is the very freedom by which seeking is occurring.

## Section 3 — Svātantrya and the Five Powers

The Five Powers of Consciousness are:
- *cit* — Consciousness itself, the Power of Self-Awareness
- *ānanda* — Bliss, the Power of intrinsic self-satisfaction
- *icchā* — Will, the primordial Power of Desire or intention
...
For the book: the spanda = svātantrya-in-vibratory-aspect framing gives the narrator's "choice is how we relate" insight its Tantrik ground. Choice is not a discrete event; it is the ongoing vibratory pulse of the whole expressing itself through each relation. The *italicized interlude: Kali speaks* in Ch4 could draw on spanda language without naming it — the pulse that makes any action, including destruction, part of the one self-determining field.

## Section 7 — Notes for the book's argument (the Tillich / svātantrya pivot)

The textual evidence cleanly supports the book's pivot thesis.

In TI's layered self (pp. 92–103), **Śūnya is the layer of dissolution — the no-thing that has to be passed through — and Cit is the layer of pure Awareness on the far side.** The Five Powers operate at the level of Cit (p. 101). Svātantrya is the one nature of which the Powers are aspects (~p. 105).

Mapped against Tillich:
- **Courage** names the act, *from the side of the finite self*, of consenting to pass through Śūnya — the self-affirmation that does not flinch at non-being.
- **Svātantrya** names the same pivot *from the side of the totality* — the freedom that was always already operating the Five Powers, and that the courageous act now consciously recognizes as its own.

They are not two events but **one event under two descriptions**: the part letting go of itself as part is the whole recognizing itself as whole.

The textual warrants for this identification are:
- Abhinavagupta's "He has only one [fundamental] quality" (TĀ 1.67) — svātantrya as the singular nature of Śiva.
- Kṣemarāja's *citiḥ svatantrā viśva-siddhi-hetuḥ* (PH 1) — Awareness, free and independent, is the cause of everything.

What Tillich approaches asymptotically through the courage-to-be in the face of non-being, the Pratyabhijñā tradition approaches from the opposite vector through the recognition (*pratyabhijñā*) that the freedom one had been seeking is the very freedom by which seeking is occurring.

**A line for the book (Ch6, possibly in the narrator's reflection after the walking-out dialogue):**
