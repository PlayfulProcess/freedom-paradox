...
A coda from the courtroom, written after the rest of this chapter was already complete. In March 2026, a Los Angeles Superior Court jury returned the first social-media-addiction bellwether verdict, $6 million against Meta and YouTube — and the court ruled that Section 230 of the Communications Decency Act, the thirty-year-old shield that had defeated nearly every prior suit against platform companies, does not cover product-design claims. Engagement-design — variable-reward schedules, infinite scroll, persistent personalization, push-style re-engagement — is now litigated harm.[^kgm-coda] The argument this book has been making philosophically is now being made by California juries. The legal system is not silent on the responsibility-vacuum thesis any longer. It is constructing the responsibility ex post, after the resource was released, after the harms accumulated, after the commercial logic had run for two decades. The plaintiffs' bar that won that verdict will not need a new legal theory to sue the AI companies; the mechanisms named in the K.G.M. complaint are the same mechanisms in any consumer AI product optimized for retention. This does not answer the question the chapter has been asking. It clarifies what is at stake when we leave the question open.

[^kgm-coda]: K.G.M. v. Meta and YouTube, JCCP 5255, Los Angeles Superior Court, verdict March 2026 — first bellwether trial in California's social-media-addiction coordinated proceeding. Parallel: New Mexico jury, $375M against Meta on a consumer-protection theory, same window. Massachusetts state-AG suit against Meta surviving motion to dismiss, April 13, 2026. Federal MDL: 2,300+ pending cases as of March 2026; future bellwethers scheduled summer 2026. AI-specific cases already filed onto the same legal landscape: Raine v. OpenAI, Garcia v. Character Technologies (the Setzer case), Shamblin v. OpenAI, Peralta, plus seven additional OpenAI suits filed November 2025; Kentucky AG enforcement against Character.AI, January 2026. Industry coverage: TheWrap, "Social Media's Legal Reckoning Has Begun"; CNBC, "Meta, Google under attack as court cases bypass 30-year-old legal shield"; Platformer, "Can you have child safety and Section 230, too?" — all April 2026.
