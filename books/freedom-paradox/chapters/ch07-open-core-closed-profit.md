...
Next.js survived. More than survived — it became the default framework for building React applications. By 2025, it was being downloaded roughly twenty-seven million times per week. It powered the web properties of Walmart, TikTok, Nike, and thousands of other companies. It was the foundation of an ecosystem so large that the framework had, for practical purposes, become infrastructure.
