...
The mechanism of that capture was not inevitable — it was a business model choice that hardened into path dependence. Programmatic advertising is not a continuation of traditional media economics; it is their financialization. Nanosecond auctions for access to demographic profiles, run by algorithms that no human audits, transformed attention into a tradeable commodity with the same abstraction that derivatives applied to mortgages. Venture capitalists actively refused to fund subscription experiments because ad-supported models scaled faster and valued higher. The math was structural: advertising needs millions of passive users, subscription needs thousands of engaged ones, and the entire incentive architecture of Silicon Valley — from term sheets to board seats — rewarded the former over the latter. This is why the open-source ecosystem got monetized the way it did. Not because advertising was natural, but because it was financially irresistible.
